...
public class ImageController {
    ...
    public ImageController(ImageService imageService, ImageRepository images, ImageViews views) {
    ...
    public String detail(@PathVariable Long id, @PathVariable String slug,
        ...
        model.addAttribute("section", "images");
        ImageService.ImageDetail detail = imageService.detail(id, slug, me.id());
        model.addAttribute("detail", detail);
        model.addAttribute("totalViews", views.recordView(detail.image().getId()));   // Redis INCR + ZINCRBY
    ...
    public String ranking(Model model) {
        model.addAttribute("section", "images");
        model.addAttribute("mostViewed", imageService.inOrder(views.topIds(10)));
        return "images/image/ranking";
    }
